		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "SMOD Calendar",
									"targetURL": "#comsmodcalendaractivity-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsmodcalendaractivity-display": {
								"semanticObject": "comsmodcalendaractivity",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.smod.calendaractivity",
									"url": sap.ui.require.toUrl("com/smod/calendaractivity")
								}
							}
						}
					}
